...
using Sorting_Algorithm_Chart.Commands;
using Sorting_Algorithm_Chart.Extensions;
using Sorting_Algorithm_Chart.Models;
using Sorting_Algorithm_Chart.Models.Algorithms;
using System.Linq;

namespace Sorting_Algorithm_Chart.ViewModels
{
    public class SortingAlgorithmViewModel
    {
        ...
        public SortingAlgorithmViewModel()
        {
